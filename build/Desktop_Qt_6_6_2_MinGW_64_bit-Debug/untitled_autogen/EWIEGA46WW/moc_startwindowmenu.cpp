/****************************************************************************
** Meta object code from reading C++ file 'startwindowmenu.h'
**
...
#error "The header file 'startwindowmenu.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSHomeWindowENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSHomeWindowENDCLASS_t qt_meta_stringdata_CLASSHomeWindowENDCLASS = {
    {
        QT_MOC_LITERAL(0, 10),  // "HomeWindow"
        QT_MOC_LITERAL(11, 8),  // "setGraph"
        QT_MOC_LITERAL(20, 0),  // ""
        QT_MOC_LITERAL(21, 6),  // "Graph*"
        QT_MOC_LITERAL(28, 20),  // "on_addButton_clicked"
        QT_MOC_LITERAL(49, 21),  // "on_editButton_clicked"
        QT_MOC_LITERAL(71, 23),  // "on_deleteButton_clicked"
        QT_MOC_LITERAL(95, 21),  // "on_exitButton_clicked"
        QT_MOC_LITERAL(117, 24)   // "on_displayButton_clicked"
    },
    "HomeWindow",
    "setGraph",
    "",
...
void HomeWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->setGraph((*reinterpret_cast< std::add_pointer_t<Graph*>>(_a[1]))); break;
        ...
        {
            using _t = void (HomeWindow::*)(Graph * );
...
// SIGNAL 0
void HomeWindow::setGraph(Graph * _t1)
{
