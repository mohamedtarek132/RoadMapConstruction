...
""));
        ...
        dynamicButton->setGeometry(QRect(810, 630, 121, 41));
        ...
        label->setGeometry(QRect(90, 620, 111, 40));
        label->setFont(font2);
