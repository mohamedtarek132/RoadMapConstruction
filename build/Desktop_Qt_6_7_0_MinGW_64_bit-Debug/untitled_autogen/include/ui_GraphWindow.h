...
public:
    ...
    QLabel *samePositionError;
    QLabel *algortihmsError;
    QLabel *outOfBoundsError;
    QLabel *invalidPositionTypeError;
    QLabel *invalidLengthTypeError;
    QLabel *sameVerticesAddError;
    QLabel *sameVerticesDeleteError;
    QLabel *alreadyExistsError;
    QLabel *doesntExistError;
...
""));
        ...
        algorithmsButton->setGeometry(QRect(670, 40, 131, 41));
        QFont font2;
        ...
        samePositionError = new QLabel(centralwidget);
        samePositionError->setObjectName("samePositionError");
        samePositionError->setEnabled(true);
        samePositionError->setGeometry(QRect(810, 140, 201, 31));
        QFont font4;
        font4.setPointSize(10);
        samePositionError->setFont(font4);
        samePositionError->setVisible(false);
        samePositionError->setStyleSheet(QString::fromUtf8("color: rgb(255, 0, 0);"));
        samePositionError->setAlignment(Qt::AlignCenter);
        algortihmsError = new QLabel(centralwidget);
        algortihmsError->setObjectName("algortihmsError");
        algortihmsError->setGeometry(QRect(500, 80, 301, 21));
        algortihmsError->setFont(font4);
        algortihmsError->setVisible(false);
        algortihmsError->setStyleSheet(QString::fromUtf8("color: rgb(255, 0, 0);"));
        outOfBoundsError = new QLabel(centralwidget);
        outOfBoundsError->setObjectName("outOfBoundsError");
        outOfBoundsError->setGeometry(QRect(840, 150, 140, 20));
        outOfBoundsError->setFont(font4);
        outOfBoundsError->setVisible(false);
        outOfBoundsError->setStyleSheet(QString::fromUtf8("color: rgb(255, 0, 0);"));
        invalidPositionTypeError = new QLabel(centralwidget);
        invalidPositionTypeError->setObjectName("invalidPositionTypeError");
        invalidPositionTypeError->setGeometry(QRect(809, 150, 211, 20));
        invalidPositionTypeError->setFont(font4);
        invalidPositionTypeError->setVisible(false);
        invalidPositionTypeError->setStyleSheet(QString::fromUtf8("color: rgb(255, 0, 0);"));
        invalidLengthTypeError = new QLabel(centralwidget);
        invalidLengthTypeError->setObjectName("invalidLengthTypeError");
        invalidLengthTypeError->setGeometry(QRect(200, 675, 211, 20));
        invalidLengthTypeError->setFont(font4);
        invalidLengthTypeError->setVisible(false);
        invalidLengthTypeError->setStyleSheet(QString::fromUtf8("color: rgb(255, 0, 0);"));
        sameVerticesAddError = new QLabel(centralwidget);
        sameVerticesAddError->setObjectName("sameVerticesAddError");
        sameVerticesAddError->setGeometry(QRect(200, 675, 211, 20));
        sameVerticesAddError->setFont(font4);
        sameVerticesAddError->setVisible(false);
        sameVerticesAddError->setStyleSheet(QString::fromUtf8("color: rgb(255, 0, 0);"));
        sameVerticesDeleteError = new QLabel(centralwidget);
        sameVerticesDeleteError->setObjectName("sameVerticesDeleteError");
        sameVerticesDeleteError->setGeometry(QRect(470, 675, 211, 20));
        sameVerticesDeleteError->setFont(font4);
        sameVerticesDeleteError->setVisible(false);
        sameVerticesDeleteError->setStyleSheet(QString::fromUtf8("color: rgb(255, 0, 0);"));
        alreadyExistsError = new QLabel(centralwidget);
        alreadyExistsError->setObjectName("alreadyExistsError");
        alreadyExistsError->setGeometry(QRect(200, 675, 211, 20));
        alreadyExistsError->setFont(font4);
        alreadyExistsError->setVisible(false);
        alreadyExistsError->setStyleSheet(QString::fromUtf8("color: rgb(255, 0, 0);"));
        doesntExistError = new QLabel(centralwidget);
        doesntExistError->setObjectName("doesntExistError");
        doesntExistError->setGeometry(QRect(470, 680, 211, 20));
        doesntExistError->setFont(font4);
        doesntExistError->setVisible(false);
        doesntExistError->setStyleSheet(QString::fromUtf8("color: rgb(255, 0, 0);"));
    ...
    void retranslateUi(QMainWindow *GraphWindow)
    {
        ...
        samePositionError->setText(QCoreApplication::translate("GraphWindow", "There is a vertex in this position!", nullptr));
        algortihmsError->setText(QCoreApplication::translate("GraphWindow", "Can't go to algortihms while graph is disconnected!", nullptr));
        outOfBoundsError->setText(QCoreApplication::translate("GraphWindow", "Position out of bounds!", nullptr));
        invalidPositionTypeError->setText(QCoreApplication::translate("GraphWindow", "Position must be a positive number!", nullptr));
        invalidLengthTypeError->setText(QCoreApplication::translate("GraphWindow", "Length must be a positive number!", nullptr));
        sameVerticesAddError->setText(QCoreApplication::translate("GraphWindow", "Vertices can't be the same!", nullptr));
        sameVerticesDeleteError->setText(QCoreApplication::translate("GraphWindow", "Vertices can't be the same!", nullptr));
        alreadyExistsError->setText(QCoreApplication::translate("GraphWindow", "Edge already exists!", nullptr));
        doesntExistError->setText(QCoreApplication::translate("GraphWindow", "Edge doesn't exist!", nullptr));
    } // retranslateUi
